...
var _randomRGB = require("../modules/RandomRGB");
const btnEle = document.querySelector(".clickMe");
const bodyEle = document.body;
const rgbObj = new (0, _randomRGB.RandomRGB)();
btnEle.addEventListener("click", ()=>{
    bodyEle.style.backgroundColor = "" + rgbObj.randomHexColor();
});
console.log("Hello, I am working."); //randomRgbColor();

},{"../modules/RandomRGB":"7pH3R"}],"7pH3R":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "RandomRGB", ()=>RandomRGB);
class RandomRGB {
    randomInteger(max) {
    ...
    randomHexColor() {
        const [r, g, b] = this.randomRGBColor();
...
},{}]},["fm8Gy","h7u1C"], "h7u1C", "parcelRequire8c1b")
